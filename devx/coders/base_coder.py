...
from devx import models, prompts, utils
from devx.commands import Commands
from devx.repomap import RepoMap
...
class Coder:
    ...
    # fences are obfuscated so devx can modify this file!
    fences = [
        ("``" + "`", "``" + "`"),
        wrap_fence("source"),
        wrap_fence("code"),
    ...
    def auto_commit(self):
        res = self.commit(history=self.cur_messages, prefix="devx: ")
        if res:
            commit_hash, commit_message = res
            self.last_devx_commit_hash = commit_hash
