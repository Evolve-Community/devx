...
from devx import __version__, models
...
def main(args=None, input=None, output=None):
    ...
    parser.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .devx.conf.yml in git root, cwd"
            " or home directory)"
        ),
    )
    ...
    default_input_history_file = (
        os.path.join(git_root, ".devx.input.history") if git_root else ".devx.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".devx.chat.history.md") if git_root else ".devx.chat.history.md"
    )
